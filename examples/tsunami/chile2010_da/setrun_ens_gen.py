...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times = np.arange(0.0, 7201.0, 900.0) #((2^x * nhrs) +1)
    ...
    rundata.gaugedata.gauges.append([14, -88.5, -29.7, 0., 1.e10])
    rundata.gaugedata.gauges.append([15, -83.7, -47.7, 0., 1.e10])
...
#-------------------
    ...
    dtopo_path = os.path.join(scratch_dir, 'dtopo_usgs100227_bias.tt3')
