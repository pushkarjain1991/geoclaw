...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times = np.arange(10800.0, 46801.0, 900.0)
    ...
    rundata.gaugedata.gauges.append([15, -88.7, -47.7, 0., 1.e10])
...
def set_PDAF(rundata):
    ...
    rundata.pdaf_data.local_range = 10.0
    return rundata
