...
!
!$Id: PDAF-D_netf_smootherT.F90 1674 2016-12-02 10:47:04Z lnerger $
!BOP
!
...
! *********************************
  ...
  CALL syevTYPE('v', 'l', dim_ens, A, dim_ens, svals, work, ldwork, flag)

  IF (flag /= 0 ) THEN
      WRITE(*,*) 'Problem in computing the SVD of W-ww^T'
  END IF
