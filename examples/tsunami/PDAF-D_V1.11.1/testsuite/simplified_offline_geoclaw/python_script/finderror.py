...
class error_between_geoclaw(object):
    ...
    def get_water(self):
        if self.type == "relative":
            error_eta = (self.test_class.eta_with_land - self.original_class.eta_with_land)
        elif self.type == "percent":
            error_eta = (self.test_class.eta_with_land - self.original_class.eta_with_land)*100.0/self.original_class.eta_with_land
        else:
