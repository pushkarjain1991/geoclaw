#!/bin/sh
#$Id: runtests_1pe.sh 1717 2016-12-20 10:49:56Z lnerger $
...
echo "--------------------------------------------------------"
$EXE $CONF -dim_ens $NENS -filtertype 8 -subtype 0 -filename output_lenkf0.dat
fi
if [ $TEST_NETF -eq 1 ]
then
echo "--------------------------------------------------------"
echo "Run NETF tests"
echo "--------------------------------------------------------"
$EXE $CONF -dim_ens $NENS -filtertype 9 -subtype 0 -filename output_netf0.dat
fi
if [ $TEST_NETF -eq 1 ]
then
echo "--------------------------------------------------------"
