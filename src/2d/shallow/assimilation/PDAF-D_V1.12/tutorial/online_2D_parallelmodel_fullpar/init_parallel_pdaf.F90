...
! !USES:
  ...
  USE mod_parallel_pdaf, &
       ONLY: mype_filter, npes_filter, COMM_filter, filterpe, &
...
!EOP
  ...
  local_npes_model = FLOOR(REAL(npes_world) / REAL(n_modeltasks+1))
  DO i = 1, (npes_world - (n_modeltasks+1) * local_npes_model(1))
